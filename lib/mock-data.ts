...
export const mockServices: Service[] = [
  {
    ...
    description:
      'Servicios completos de plomería: reparación de llaves, destapado de drenajes, instalación de regaderas, y mantenimiento general.',
    category: 'Plomería',
    provider: {
      name: 'Carlos Jiménez',
      rating: 4.9,
  ...
  },
  {
    ...
    description:
      'Instalaciones eléctricas, reparación de contactos, instalación de ventiladores, iluminación LED y revisiones de seguridad.',
  ...
  },
  {
    ...
    description:
      'Fabricación y reparación de muebles, closets a medida, reparación de puertas y ventanas de madera.',
  ...
  },
  {
    ...
    description:
      'Servicio de limpieza para hogar y oficina. Limpieza profunda, mantenimiento regular, limpieza post-construcción.',
    category: 'Limpieza',
    provider: {
      name: 'Lucía Martínez',
      rating: 4.9,
  ...
  },
  {
    ...
    description:
      'Servicios de pintura interior y exterior, aplicación de texturas decorativas, restauración de fachadas.',
    category: 'Pintura',
    provider: {
      name: 'Miguel Torres',
      rating: 4.6,
  ...
  },
  {
    ...
    description:
      'Diseño y mantenimiento de jardines, poda de árboles, instalación de sistemas de riego, plantas ornamentales.',
    category: 'Jardinería',
    provider: {
      name: 'Patricia Silva',
      rating: 4.8,
